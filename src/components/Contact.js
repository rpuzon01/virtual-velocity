...
const Contact = () => {
  return <section className="mb-4 safe" id="contactTop">
    ...
    <p className="text-center w-responsive mx-auto mb-5">Got questions? Awesome, we got answers. </p>

        <form id="contact-form" name="contact-form" action="mailto:bboysamuel@hotmail.com" method="POST" >
